  ...
  <div class="projects-grid">
    ...
    >
      ...
      <p class="project-description">
        A full-stack shared calendar, notes and files system for friends and
        family.
      </p>
    ...
    >
      ...
      <p class="project-description">
        How's that for recursion? This is a fairly simple website that I made to
        introduce myself and showcase some of my skills. It was also a way for
        me to learn and practice Svelte.
      </p>
      <div class="stack-chips">
    ...
    >
      ...
      <p class="project-description">
        An over-engineered solution to a problem of having a list of things, but
        now knowing the order, ie. favourite films. This app comes in to use an
        elo system to show you all the comparisons, and then create a ranked
        table.
      </p>
      <div class="stack-chips">
        <span class="stack-chip svelte">Svelte</span>
    ...
    >
      ...
      <p class="project-description">
        A web app to transcribe uploaded audio into text, using the OpenAI
        Whisper model. Returns text and a .txt file download. Deployed with
        Flask, ffmpeg on a VPS.
      </p>
      <div class="stack-chips">
        <span class="stack-chip js">JavaScript</span>
