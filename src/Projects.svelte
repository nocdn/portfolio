...
<div class="projects-content content">
    ...
    <div class="projects-grid">
        ...
        <div class="project-card lightPurple" style="opacity: {shownProjects >= 5? 1 : 0};">
          <img
            src="src/assets/projects-images/portfolio-site.png"
            alt="a screenshot of a language learning app"
            class="project-image"
          ...
          <p class="project-description">
            A web app to transcribe uploaded audio into text, using the OpenAI Whisper model. Returns text and a .txt file download. Deployed with Flask, ffmpeg on a VPS.
          </p>
          <div class="stack-chips">
            <span class="stack-chip js">JavaScript</span>
